<div align="center">
  ...
  <p>
    <a href="https://github.com/abnste/mewu_ai/releases/tag/v0.5.2"><img src="https://img.shields.io/badge/公测版-v0.5.2-7C6CF0?style=flat-square" alt="v0.5.2 公测版" /></a>
  ...
  <p>
    <a href="https://github.com/abnste/mewu_ai/releases/download/v0.5.2/MewuAI-Setup-0.5.2-win-x64.exe"><strong>下载安装版</strong></a>
    &nbsp;·&nbsp;
    <a href="https://github.com/abnste/mewu_ai/releases/download/v0.5.2/MewuAI-Portable-0.5.2-win-x64.zip">免安装版</a>
  </p>
...
作者：**Abner Stephen**、**Yandi** 和 [**数字星星**](https://github.com/shuziyuxingxing-stack)。
...
感谢**林文杰老师**提供学科帮助，**张文彪老师**提供功能开发建议。
